...
const config = {
    ...
    firebase: {
        ...
        identityToolkitKey: flags.firebaseITK ||
        ...
        clientVersion: flags.firebaseClientVersion ||
        ...
        clientToken: flags.firebaseClientToken ||
    ...
    network: {
        ...
        oembedProtocol: flags.oembedProtocol ||
